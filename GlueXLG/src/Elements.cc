...
//  fElementsList.push_back(W);
  ...
  // Argon
  G4Element* elAr = G4NistManager::Instance()->FindOrBuildElement("Ar");
  fElementsList.push_back(elAr);

  // Chlorine
  G4Element* elCl = G4NistManager::Instance()->FindOrBuildElement("Cl");
  fElementsList.push_back(elCl);
}
